...
df<-read.table(paste(nome,"_after_rem_batch.txt",sep=""),header=FALSE,sep="\t",dec=".",row.names=nl,col.names=nc)
...
plot(mds, col=cols[platform], pch=shps[tipo], asp=1, xlab = "", ylab = "", main="MDS plot after batch-adjustment")
